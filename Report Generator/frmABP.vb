...
Public Class frmABP
    ...
    'com1 = com1 & "(SELECT DISTINCT PJP, SUM(JUM_OUT) AS JUM_OUT, COUNT(DOC_NO) AS JUM_INV FROM("
    'com1 = com1 & "SELECT a.PJP,COUNT(a.POP) AS JUM_OUT, b.DOC_NO as DOC_NO,b.SKU, b.QTY1,b.QTY2,b.QTY3 "
